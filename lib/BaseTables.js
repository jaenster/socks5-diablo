...
{ // Just a block =)
	...
	const models = {BaseStat, BaseItemType, BaseMiscItem, BaseArmor, BaseWeapon};
	const csvs = ['BaseStat', 'BaseItemType', 'BaseMiscItem', 'BaseArmor', 'BaseWeapon'].map(x => [__dirname + '\\..\\data\\' + x + '.csv', x]);
