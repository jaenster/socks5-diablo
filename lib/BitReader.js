...
class BitReader {
	...
	constructor(data) {
		...
		[Buffer.prototype.readUInt16LE, Buffer.prototype.readUInt32LE, Buffer.prototype.readBigUInt64LE,
			Buffer.prototype.readInt16LE, Buffer.prototype.readInt32LE, Buffer.prototype.readBigInt64LE]
			// Get size of buffer
			.map(func => ({func, size: parseInt(func.name.substr(-4, 2)) / 8}))
